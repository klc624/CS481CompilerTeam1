...
### compiler > BuildAst.java
  ...
  ##### visitTArray(): 
  ###### changed type from visit() to .accept(this)
  ###### corrected return statement

  ##### visitTInt(), visitTByte(), visitTFloat(), visitTChar(), visitTBool(): 
  ###### corrected return statement
...
### compiler > PrettyPrinter.java
  ...
  ##### ExpBinop, ExpUnop: 
  ###### added use of parenthesis()

  ##### ExpChar: 
  ###### added use of deEscaping(); added single quotes

  ##### ExpString: 
  ###### added use of deEscaping()
  ...
  ##### StmFor: 
  ###### corrected spaces() order

  ##### StmWhile: 
  ###### added use of parenthesis(); added missing end block curly brace

  ##### ExpFuncCall: 
  ###### updated to use buildCall()
